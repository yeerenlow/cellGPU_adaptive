#ifndef SELF_PROPELLED_PARTICLE_WITH_EDGE_FRICTION_H
#define SELF_PROPELLED_PARTICLE_WITH_EDGE_FRICTION_H
...
class selfPropelledParticleWithEdgeFriction : public selfPropelledParticleDynamics
{
public:
    // Constructor
    selfPropelledParticleWithEdgeFriction(int _N, double _gamma_rel = 1.0, bool _useGPU = true);
    ~selfPropelledParticleWithEdgeFriction()
    {
